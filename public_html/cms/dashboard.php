		...
		<div id="tabs">
			...
			<div class="tab-content medium-11 columns">
				...
				<div id="tabs-2">
					...
					<div class="medium-12 columns">
						<?php
						$files_query = "SELECT * FROM files_table";
						...
						if($files_count > 0){
							while($files_row = mysqli_fetch_assoc($files_result)){
								$fileName = $files_row["file_name"];
								$uploaded = $files_row["uploaded"];
								// file url (change)
				...
				<div id="tabs-3">
					...
					<div>
						<?php
							...
							$about_count=mysqli_num_rows($about_result);
							if($about_count > 0){
